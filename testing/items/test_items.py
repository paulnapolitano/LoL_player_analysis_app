...
class Build:
    def __init__(self, build_components=[], last_timestamp=-100000, batch_number=0):
        self.build_components = build_components
    ...
    def sell(self, item, timestamp):
        ...
        self.build_components[last_index].death_time = timestamp
